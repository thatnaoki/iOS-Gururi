//
//  InvitationEditViewController.swift
//  Gururi
//
...
class EditInvitationViewController: UIViewController {
    ...
    func configureTextFields() {
        ...
        peopleTextField.text = invitation.people
        dateTextField.text = invitation.date
        timeTextField.text = invitation.time
        telTextField.text = invitation.tel
    }
